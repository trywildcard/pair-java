...
before :each do
  ...
  price2 = WildcardPair::Price.new price: 7.99
    @validsearchresult = WildcardPair::ProductSearchResult.new price: price, name: 'ProductResult', product_card_url: 'http://brand.com/product/123'
...
describe '#new' do
  it "takes returns a ProductSearchCard object" do
    product_search_card = WildcardPair::ProductSearchCard.new search_results: @validsearchresult, total_results: 2
...
describe '#new2' do
  it "takes returns a ProductCard object" do
    product_search_card = WildcardPair::ProductSearchCard.new search_results: @validsearchresults, total_results: 2
    product_search_card.should be_an_instance_of WildcardPair::ProductSearchCard
    product_search_card.valid?.should eql true
    product_search_card.search_results.is_a?(Array).should eql true
    product_search_card.card_type.should eql 'product_search'
...
describe '#no_total_results' do
  it "no total results" do
    product_search_card = WildcardPair::ProductSearchCard.new search_results: @validsearchresults
    product_search_card2 = WildcardPair::ProductSearchCard.new search_results: @validsearchresults, total_results: nil
...
describe '#invalid_total_results' do
  it "invalid_total_results" do
    product_search_card = WildcardPair::ProductSearchCard.new search_results: @validsearchresults, total_results: -10
...
describe '#nosearchresults' do
  product_search_card = WildcardPair::ProductSearchCard.new search_results: nil, total_results: 2
...
describe '#invalidsearchresults' do
  ...
  invalidSearchResult = WildcardPair::ProductSearchResult.new price: invalidprice, name: 'ProductResult', product_card_url: 'http://brand.com/product/123'
  ...
  product_search_card = WildcardPair::ProductSearchCard.new search_results: invalidsearchresults1, total_results: 3
  product_search_card2 = WildcardPair::ProductSearchCard.new search_results: invalidsearchresults2, total_results: 3
