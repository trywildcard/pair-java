...
describe '#noname' do
  it "no name" do
    price = WildcardPair::Price.new price: 5
    product_search_result = WildcardPair::ProductSearchResult.new price: price, product_card_url: 'http://brand.com/product/123'
...
describe '#noprice' do
  it "no price" do
    product_search_result = WildcardPair::ProductSearchResult.new name: 'ProductResult', product_card_url: 'http://brand.com/product/123'
    product_search_result.valid?.should eql false
    expect {product_search_result.to_json}.to raise_error(RuntimeError)
  end
end
...
describe '#invalidprice' do
  it "no name" do
    ...
    product_search_result = WildcardPair::ProductSearchResult.new price: invalidprice, name: 'ProductResult', product_card_url: 'http://brand.com/product/123'
    product_search_result.valid?.should eql false
    expect {product_search_result.to_json}.to raise_error(RuntimeError)
  end
end
...
describe '#noproducturl' do
  it "no producturl" do
    product_search_result = WildcardPair::ProductSearchResult.new name: 'ProductResult'
    product_search_result.valid?.should eql false
    expect {product_search_result.to_json}.to raise_error(RuntimeError)
  end
end
