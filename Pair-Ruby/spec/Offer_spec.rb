...
describe '#invalid_price' do
	offer = PairSDK::Offer.new price: -1
...
describe '#no_original_price' do
	offer = PairSDK::Offer.new price: 5, original_price: nil
...
describe '#negative_original_price' do
	offer = PairSDK::Offer.new price: 5, original_price: -2
...
describe '#original_price' do
	offer = PairSDK::Offer.new price: 5, original_price: 4
...
describe '#no_shipping_cost' do
	offer = PairSDK::Offer.new price: 5, shipping_cost: nil
...
describe '#negative_shipping_cost' do
	offer = PairSDK::Offer.new price: 5, shipping_cost: -2
...
describe '#shipping_cost' do
	offer = PairSDK::Offer.new price: 5, shipping_cost: 4
	it "original price" do
		offer.valid?.should eql true
...
describe '#nil_description' do
	offer = PairSDK::Offer.new price: 5, description: nil
...
describe '#empty_description' do
	offer = PairSDK::Offer.new price: 5, description: ''
...
describe '#description' do
	offer = PairSDK::Offer.new price: 5, description: 'offer description'
	it "description" do
		offer.valid?.should eql true
...
describe '#nil_availability' do
	offer = PairSDK::Offer.new price: 5, availability: nil
...
describe '#invalid_availability' do
	offer = PairSDK::Offer.new price: 5, availability: 'NotExist'
...
describe '#availability' do
	offer = PairSDK::Offer.new price: 5, availability: 'OnlineOnly'
	it "availability" do
		offer.valid?.should eql true
...
describe '#nil_gender' do
	offer = PairSDK::Offer.new price: 5, gender: nil
	it "nil_gender" do
		offer.valid?.should eql true
	end
end
...
describe '#invalid_gender' do
	offer = PairSDK::Offer.new price: 5, gender: 'malefemale'
...
describe '#gender' do
	offer = PairSDK::Offer.new price: 5, gender: 'unisex'
	it "gender" do
		offer.valid?.should eql true
...
describe '#no_weight' do
	offer = PairSDK::Offer.new price: 5, weight: nil
	it "no weight" do
		offer.valid?.should eql true
	end
end
...
describe '#negative_weight' do
	offer = PairSDK::Offer.new price: 5, weight: -2
...
describe '#weight' do
	offer = PairSDK::Offer.new price: 5, weight: 4.5
	it "weight" do
		offer.valid?.should eql true
...
describe '#no_quantity' do
	offer = PairSDK::Offer.new price: 5, quantity: nil
	it "no quantity" do
		offer.valid?.should eql true
	end
end
...
describe '#negative_quantity' do
	offer = PairSDK::Offer.new price: 5, quantity: -2
...
describe '#non_integer_quantity' do
	offer = PairSDK::Offer.new price: 5, quantity: 2.5
...
describe '#quantity' do
	offer = PairSDK::Offer.new price: 5, quantity: 400
	it "quantity" do
		offer.valid?.should eql true
...
describe '#invalidofferjson' do
	offer = PairSDK::Offer.new price: 5, quantity: -100
