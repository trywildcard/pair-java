...
describe '#invalid_price' do
	price = PairSDK::Price.new price: -1
	offer = PairSDK::Offer.new price: price
...
describe '#no_original_price' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, original_price: nil
...
describe '#negative_original_price' do
	price = PairSDK::Price.new price: 5
	originalprice = PairSDK::Price.new price: -2
	offer = PairSDK::Offer.new price: price, original_price: originalprice
...
describe '#original_price' do
	price = PairSDK::Price.new price: 5
	originalprice = PairSDK::Price.new price: 4
	offer = PairSDK::Offer.new price: price, original_price: originalprice
...
describe '#no_shipping_cost' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, shipping_cost: nil
...
describe '#negative_shipping_cost' do
	price = PairSDK::Price.new price: 5
	shippingcost = PairSDK::Price.new price: -2
	offer = PairSDK::Offer.new price: price, shipping_cost: shippingcost
...
describe '#shipping_cost' do
	price = PairSDK::Price.new price: 5
	shippingcost = PairSDK::Price.new price: 4
	offer = PairSDK::Offer.new price: price, shipping_cost: shippingcost
	it "original price" do
		offer.valid?.should eql true
...
describe '#nil_description' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, description: nil
...
describe '#empty_description' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, description: ''
...
describe '#description' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, description: 'offer description'
	it "description" do
		offer.valid?.should eql true
...
describe '#nil_availability' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, availability: nil
...
describe '#invalid_availability' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, availability: 'NotExist'
...
describe '#availability' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, availability: 'OnlineOnly'
	it "availability" do
		offer.valid?.should eql true
...
describe '#nil_gender' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, gender: nil
	it "nil_gender" do
		offer.valid?.should eql true
	end
end
...
describe '#invalid_gender' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, gender: 'malefemale'
...
describe '#gender' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, gender: 'unisex'
	it "gender" do
		offer.valid?.should eql true
...
describe '#no_weight' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, weight: nil
	it "no weight" do
		offer.valid?.should eql true
	end
end
...
describe '#negative_weight' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, weight: -2
...
describe '#weight' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, weight: 4.5
	it "weight" do
		offer.valid?.should eql true
...
describe '#no_quantity' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, quantity: nil
	it "no quantity" do
		offer.valid?.should eql true
	end
end
...
describe '#negative_quantity' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, quantity: -2
...
describe '#non_integer_quantity' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, quantity: 2.5
...
describe '#quantity' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, quantity: 400
	it "quantity" do
		offer.valid?.should eql true
...
describe '#invalidofferjson' do
	price = PairSDK::Price.new price: 5
	offer = PairSDK::Offer.new price: price, quantity: -100
